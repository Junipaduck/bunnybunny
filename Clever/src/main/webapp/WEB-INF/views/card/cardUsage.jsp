...
<div class="content">
	<div class="section-inner">
		<div class="subpage-title-area">
			<h2 class="title">My 카드조회</h2>
			<p class="sub-text">나의 카드내역을 조회할 수 있습니다.</p>
		</div>
		<!-- 이번 달 총 사용 금액 출력 시작 -->
		<div class="description-list member-box" style="width: 400px; height: 70px; margin-bottom: 30px;">
			<dl>
				<dt tabindex="0" style="width: 200px;">[${member.member_name }홍길동]님의 카드 상세 내역</dt>
				<dd tabindex="0">300,000원</dd>
			</dl>
		</div>
		<!-- 이번 달 총 사용 금액 출력 끝 -->
		<div class="contents-container-wrap">
			...
			<!-- 카드별 요약 시작 -->
				<button class="btn normal medium" style="margin-bottom: 20px;">카드 연결 추가하기</button>
				<div class="list-wrapper">
					<div class="list-item card">
						...
						<div class="description" style="float: right; width: 10%;">
							<button class="btn accent small" onclick="location.href='cardUsageDetail.ca'">상세조회</button>
						</div>
